...
const Header = () => {
    return (
        <main>
      <header class="bg-white shadow-lg h-22 hidden md:flex">
  <a href="" class="border flex-shrink-0 flex items-center justify-center px-4 lg:px-6 xl:px-8">
    <span className="logo">NewsCentral</span>
  </a>
  ...
  <div class="border flex items-center px-4 lg:px-6 xl:px-8">
    ...
    <button class="bg-black hover:bg-gray-700 text-white font-bold px-4 xl:px-6 py-2 xl:py-3 rounded">Sign out</button>
  </div>
</header>
