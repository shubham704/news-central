      ...
      <header class="bg-gray-800 text-white">
             ...
             <nav class="bg-gray-800">
                 <div class="flex justify-center space-x-6 p-4">
                     ...
                     <a href="./search?q=world" class="hover:text-gray-400">World</a>
                     <a href="./search?q=Politics" class="hover:text-gray-400">Politics</a>
                     <a href="./search?q=Business" class="hover:text-gray-400">Business</a>
                     <a href="./search?q=Technology" class="hover:text-gray-400">Technology</a>
                     <a href="./search?q=Sports" class="hover:text-gray-400">Sports</a>
                     <a href="./search?q=Entertainment" class="hover:text-gray-400">Entertainment</a>
                     <a href="./search?q=Travel" class="hover:text-gray-400">Travel</a>
                 </div>
             </nav>
